 ...
 *
 * Copies every file to targetRoot using the {@link File#lastModified() file date}
 * and type (file suffix) to determine
...
//Volumes/Leopard/Users/marcus/Pictures/backup/xfer'


final File sourceDir      = assertIsExistingDirectory '/Volumes/toshi_1tb/Sonstiges/_backup_/iPhone/iphone_29.03.15'
final File destinationDir = assertIsExistingDirectory '/Volumes/toshi_1tb/t'
...
sourceDir.eachFile(FileType.FILES) { final File srcFile ->
    ...
    final destFile = new File("${destinationDir.absolutePath}/$mediaFolder/$year/$month", srcFile.name)
